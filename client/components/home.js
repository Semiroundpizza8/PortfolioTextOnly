...
export function Home() {
  ...
  return (
    <div>
      <h1 style={textStyle}>Hello you beautiful, wonderful person. I’m <NavLink to="/about" onMouseDown={(event) => {event.preventDefault()}}>{overlap('Benjamin Odisho', 'yellow')}</NavLink> and this is my site. </h1>
